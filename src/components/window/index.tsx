...
export default class Window extends React.Component<WindowProps, {}> {
    ...
    return (
      ...
      >
        ...
        <div
          ...
          onMouseDown={e => this.handleMouseDown(e, ResizeType.Left)}
        />
        <div
          className="window-resize window-resize-right"
          onMouseDown={e => this.handleMouseDown(e, ResizeType.Right)}
        />
        <div
          className="window-resize window-resize-bottom"
          onMouseDown={e => this.handleMouseDown(e, ResizeType.Bottom)}
        />
        <div
          className="window-resize window-resize-left-bottom"
          onMouseDown={e => this.handleMouseDown(e, ResizeType.LeftBottom)}
        />
        <div
          className="window-resize window-resize-right-bottom"
          onMouseDown={e => this.handleMouseDown(e, ResizeType.RightBottom)}
        />
      </div>
    );
  }
  ...
  private handleMouseDown = (
    ...
    if (type === "move") {
      this.isMoving = true;
    } else if ((Object as any).values(ResizeType).includes(type)) {
      // type in ResizeType
  ...
  private handleMouseMove = (e: MouseEvent) => {
    ...
    if (this.isMoving) {
      ...
      if (top < 0) {
        top = 0;
      } else if (top > document.body.clientHeight - 50) {
